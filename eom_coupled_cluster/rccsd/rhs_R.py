...
def build_right_sigma_ai(V_t, f, u, R0, R1, R2, L0, L1, L2, t, Hbar, o, v, np):
    t2 = t[0]
...
def build_right_sigma_abij(V_t, f, u, R0, R1, R2, L0, L1, L2, t, Hbar, o, v, np):
    t2 = t[0]
    tmp = u[o, o, v, v].copy()
...
def build_right_sigma_ai_drudge(V_t, f, u, R0, R1, R2, L0, L1, L2, t2, o, v, np):
...
def build_right_sigma_abij_drudge(V_t, f, u, R0, R1, R2, L0, L1, L2, t2, o, v, np):
    """
